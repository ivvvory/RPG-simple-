...
def build_deck():
    ...
    return [
        ...
        Card("Great Slash: Horizontal", "attack", [coin1, coin1], lambda c, o: print("Damage x coins!")),
        ...
        Card("Counter", "counter", [coin2], lambda c, o: print(f"{c.name} counters!")),
